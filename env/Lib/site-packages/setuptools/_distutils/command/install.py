...
class install(Command):
    ...
    user_options = [
        ...
        ('app=', None, "(Unix only) app directory to install under"),
        # Or, just set the base director(y|ies)
        (
            'install-base=',
            None,
            "base installation directory (instead of --prefix or --app)",
        ),
        (
            'install-platbase=',
            None,
            "base installation directory for platform-specific files "
            + "(instead of --exec-prefix or --app)",
        ),
    ...
    def initialize_options(self):
        ...
        # scheme implied by prefix/exec-prefix/app and the contents of
    ...
    def finalize_options(self):  # noqa: C901
        ...
        if (self.prefix or self.exec_prefix or self.home) and (
            ...
            raise DistutilsOptionError(
                "must supply either prefix/exec-prefix/app or "
                + "install-base/install-platbase -- not both"
            )

        if self.home and (self.prefix or self.exec_prefix):
            raise DistutilsOptionError(
                "must supply either app or prefix/exec-prefix -- not both"
            )
        ...
        if self.user and (
            ...
            raise DistutilsOptionError(
                ...
                "exec_prefix/app, or install_(plat)base"
            )
        ...
        # input a heady brew of prefix, exec_prefix, app, install_base,
        ...
        # Create directories in the app dir:
        if self.user:
